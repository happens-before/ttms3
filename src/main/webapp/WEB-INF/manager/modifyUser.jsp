...
<div class="layui-layout layui-layout-admin">
  ...
  <!-- 增加员工信息 -->
        <div class="col-md-10" style="margin-left: 150px;margin-top: 30px;">
            <form class="form-horizontal" role="form" name="myform" action="user?method=update" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="emp_pass" name="emp_pass"
                            placeholder="请输入真实姓名,10字以内" pattern="^(0|[1-9][0-9]*)"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="type" name="type"
                            placeholder="请输入手机号码" pattern="^[0-9]*" 
                            required="required" oninvalid="setCustomValidity('管理员为1，普通员工为0')"
                            oninput="setCustomValidity('')" value="${user.type}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="emp_tel_num" class="col-sm-2 control-label">用户头像</label>
                    <div class="col-sm-6">
                        <input type="file"  id="head_path" name="head_path"
                            oninput="setCustomValidity('')" value="${user.head_path}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <button type="submit" class="btn btn-primary" onclick="return isPic()">提  交</button>                     
                    </div>
                </div>
            </form>
...
function isPic()
{
    var pic=myform.head_path.value;
